  ...
  return (
    <html lang="en">
      <head>
        ...
        {/** Preload the heavy assets to start fetching earlier */}
        <link rel="preload" href="/office.glb" as="fetch" crossOrigin="anonymous" />
        <link rel="preload" href="/baked-office-textures.png" as="image" />
