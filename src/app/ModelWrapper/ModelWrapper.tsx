...
const Office: React.FC<OfficeProps> = ({ model, scale, isInteractiveMode }) => {
  ...
  useFrame(() => {
    if (!isInteractiveMode && groupRef.current && scroll) {
      ...
      if (isSmallScreen) {
        animateSectionBorders('section-one', scroll.offset, 200, 10, 10, 200, 0.06, 0.095, 0.154, 0.19);
        animateSectionBorders('section-two', scroll.offset, 200, 10, 10, 200, 0.275, 0.33, 0.552, 0.6);
        animateSectionBorders('section-three', scroll.offset, 200, 10, 10, 200, 0.69, 0.75, 0.848, 0.89);
        ...
        animateSectionBorders('section-one', scroll.offset, 200, 10, 10, 200, 0.056, 0.11, 0.148, 0.185);
        animateSectionBorders('section-two', scroll.offset, 200, 10, 10, 200, 0.28, 0.34, 0.55, 0.61);
        animateSectionBorders('section-three', scroll.offset, 200, 10, 10, 200, 0.7, 0.75, 0.84, 0.88);
