    ...
    return (
        <div>
            <Section id="one" title="About Me" number="01">
                <p className="section-text">Hello internet <span className="wave">👋</span></p>
                <p className="section-text"> My name is Ahmad Jamal, but you can call me Jamal. I'm a Full-Stack Developer based in Calgary currently working remotely for an awesome travel company FreshTracks, located in the heart of Vancouver.</p>
                <p className="section-text">Having worked professionally as a developer for almost 4 years, I've had the pleasure of collaborating with some exciting startups such as HigherGround, FreshGrade, and Fresh Tracks Canada. These experiences have allowed me to hone my development skills and gain valuable insights into the industry.</p>
                <p className="section-text">I'm a big believer in always pushing myself to learn new things, which is why I've poured my heart and soul into the revamp of my old portfolio. I've used some fantastic tools like NextJS, Tailwind, and Three.js to create the skeleton of the website and Blender to create a 3D model of my office.</p>
                <p className="section-text">So, dive in and have fun exploring!</p>
            </Section>
            ...
            <Section id="three" title="What I can do for you" number="03">
                <ol>
                    <li className="section-heading">Web Development</li>
                    ...
                    <li className="section-heading">Search Engine Optimization</li>
                    <p className="section-text"></p>
                    <ul className="section-text">
                        <li>
                    ...
                    <li className="section-heading">CMS Management</li>
                    <p className="section-text"></p>
                    <ul className="section-text">
                        <li>
                    ...
                    <li className="section-heading">CI/CD</li>
                    <p className="section-text"></p>
                    <ul className="section-text">
                        <li>
                    ...
                    <li className="section-heading">Solution Architect</li>
                    <p className="section-text"></p>
                    <ul className="section-text">
                        <li>
