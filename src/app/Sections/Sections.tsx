  ...
  return (
    <SectionsContainer>
      <Section id="one" title="About Me" number="01">
        <Text>
          Hello World <WavingHand role="img" aria-label="wave">👋</WavingHand>
        </Text>
        ...
        <Text>
          I am a big believer in constantly pushing yourself and learning something new everyday. That's why I poured my heart and soul into revamping my old portfolio.
          I've used fantastic, modern tools like Next.js, Tailwind, and Three.js to build the website's skeleton; and Blender to create a 3D model of my office.
        </Text>
      ...
      <Section id="two" title="My Work" number="02">
        ...
        <Text>
          My latest endeavor has been diving into ThreeJS and creating fun, small projects by following this amazing{' '}
          <a href="https://threejs-journey.com/">course by Bruno Simon</a>. I've worked on both small and large-scale projects,
          including my portfolio, which leverages ThreeJS to its fullest.
        </Text>
        ...
        <Text>
          During my time at Fresh Tracks Canada I have worked on challenging projects like managing CI/CD setups for seamless development,
          A/B testing for user insights, Personalization for tailored content, and crafting a monorepo with complex pathways among other projects.
        </Text>
        <Text>
          I have also created websites from the ground up. Here are a few examples of the websites I have worked on,
          showcasing my skills in creating new pages and components, managing CI/CD processes, developing complex API pathways,
        ...
        <Text>
          Laurie, an artist, aimed to showcase her talent and reach a broader audience through improved SEO and enhanced performance.
        </Text>
        <Text>
          In collaboration with Laurie, I enhanced performance metrics, optimized her website for Google search rankings,
          set up Google Analytics and Google Console, and provided guidance on content creation and marketing strategies for her products.
        </Text>
        <Text>
          Here is my complete research and thought process of how I made this possible:{' '}
          <a href="https://wandering-psychology-b1a.notion.site/SEO-Optimization-Analysis-41a6620719af46ee9be5636e88f38d15?pvs=4" target="_blank" rel="noopener noreferrer">
            SEO Optimization Analysis on Notion
          </a>
        </Text>
        <Text>
          And you can check out her website <a href="https://www.lauriekoss.com/" target="_blank" rel="noopener noreferrer">here</a>.
        </Text>
      </Section>
      ...
      <Section id="three" title="What I'm Good At" number="03">
        ...
        <SectionList>
          <ListItem>Automation, testing, and deployment to make developers life easier and making code robust</ListItem>
          <ListItem>Optimizing deployments and ensuring everything flows smoothly to help cut down on coffee breaks while waiting for your code to deploy</ListItem>
        </SectionList>

        <Heading>Solution Architect</Heading>
        <SectionList>
          <ListItem>Designing solutions for every day web problems</ListItem>
          <ListItem>Researching, testing, and implementing the best ways to solve problems that keep people up at night</ListItem>
        </SectionList>

        <Heading>CMS Management</Heading>
        <SectionList>
          <ListItem>Setting up, updating, and maintaining various CMS</ListItem>
          <ListItem>Ensuring project's plugins are always on their latest and greatest versions</ListItem>
        </SectionList>
      </Section>
